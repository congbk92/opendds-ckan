...
ckan = ckanapi.RemoteCKAN('http://127.0.0.1:5000', apikey="b3c5e73a-52ef-4156-96eb-ef022746ea74", user_agent='opencouncildata testing')


# try:
#     print('Creating package')
#     package = ckan.action.package_create(name='test-datastore-package', owner_org="test")
